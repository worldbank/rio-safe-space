	...
	* Are women more likely to take the survey, controlling for platform?
	...
	test (i2.platform == 0) (i6.platform == 0) (i8.platform == 0) (i11.platform == 0) (i12.platform == 0)
	...
	* (Only applies to men invited to take IAT)
	...
	copy "${out_tables}/response.tex" "${out_github}/response.tex", replace
